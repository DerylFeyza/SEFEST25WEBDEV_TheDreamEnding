        ...
        <div className="lg:grid-cols-2 lg:gap-8 grid items-center gap-12">
          <div className="max-w-2xl">
            ...
            <div className="sm:flex-row flex flex-col gap-4 mt-8">
              <Button size="lg" className="hover:bg-green-700 hover:opacity-100 bg-green-600">
                <Link href="/rent">
                    Start Renting
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="hover:bg-green-50 hover:opacity-100 text-green-600 border-green-600">
                Learn More
              </Button>
            </div>
          </div>
